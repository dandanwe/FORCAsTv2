...
!      INTEGER             ndspec !ka - added deposition of meoh and etoh; added ndspec
      ...
      REAL(KIND=dp), DIMENSION(nlev,NREACT):: rconst_updated 
      REAL(KIND=dp), DIMENSION(nlev):: iso_loss 
!**********************************************************************
...
c ##############################################################
      ...
      open(unit=321,file='out/depr.out',status='unknown')        !ddw - reaction rates
...
!      open(unit=35, file='out/cacm_gprd.out',status='unknown')
